...
the [SARL Language Reference](../../lang/index.html).

<div class="bt-download">
<a href="[:examples.gitbase.url!]/io-sarl-tutorials-pingpong/src/main/sarl/io/sarl/examples/pingpong"><img alt="See the code" src="http://www.sarl.io/images/download-icon.png"/></a>
</div>
...
in the [GitHub of the SARL demos](https://github.com/sarl/sarl/tree/master/sarl-eclipse/plugins/io.sarl.eclipse.examples/projects/io-sarl-tutorials-pingpong/src/main/sarl/io/sarl/examples/pingpong).
...
[Agent Reference](../../lang/aop/Agent.html),
...
[Janus runtime environment](http://www.sarl.io/runtime/janus/) for running the agents.
