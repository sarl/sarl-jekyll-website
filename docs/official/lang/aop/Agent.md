...
<ul>
  ...
  <li><a href="#46-generic-events-in-handlers">4.6. Generic Events in Handlers</a></li>
  <li><a href="#47-specific-agent-architectures">4.7. Specific Agent Architectures</a></li>
</ul>
...
[Janus runtime environment](http://www.sarl.io/runtime/janus/).
...
According to the [Expression Syntax Reference](../expr/VarDecls.html),
...
The syntax described is described in the [Function Syntax Reference](../expr/FuncDecls.html).
...
All the [modifiers for the nested types](../oop/Class.html) are allowed **except**
`public`. 
...
`EventName` is the name of the events to wait for. It could contains generic type declaration. `Guard` is the optional definition of a predicate
...
### 4.6. Generic Events in Handlers
...
### 4.7. Specific Agent Architectures

It is possible to define the behaviors of an agent according to a specific and already known agent architecture.
SARL API provides a list of well-known agent architectures that are listed [here](../sdk/AgentArchitectures.html).
...
[General Syntax Reference](../expr/Extension.html) describes the "extension method"
