...
<ul>
  ...
  <li><a href="#26-generic-events-in-handlers">2.6. Generic Events in Handlers</a></li>
</ul>
...
According to the [Variable Syntax Reference](../expr/VarDecls.html), the attributes may be
...
[Function Syntax Reference](../expr/FuncDecls.html) is used.
...
[this section](../oop/Modifiers.html).
...
### 2.6. Generic Events in Handlers
