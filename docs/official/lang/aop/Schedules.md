...
<li><a href="#11-version-specification">11. Version Specification</a></li>
...
the [General Syntax Reference](../expr/Lambda.html)) to an executor provided by the runtime
...
the [General Syntax Reference](../expr/Lambda.html)) to
