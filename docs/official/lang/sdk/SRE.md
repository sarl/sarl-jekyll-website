...
A run-time environment, such as [Janus](http://www.sarl.io/runtime/janus/) must provide an implementation of this bootstrap interface.
...
`io.sarl.lang.core.SREBootstrap` into its `META-INF/services/io.sarl.lang.core.SREBootstrap` file (for Java 8 or higher) or in its service declaration into the module definition (for Java 9 or higher):
