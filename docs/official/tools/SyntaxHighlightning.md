...
<li><a href="#1-gnu-source-highlight">1. GNU source-highlight</a></li>
<li><a href="#2-google-code-prettify">2. Google Code Prettify</a></li>
<li><a href="#3-gtk-source-view">3. Gtk Source View</a></li>
<li><a href="#4-latex">4. LaTeX</a></li>
<ul>
  <li><a href="#4-1-standard-latex-style">4.1. Standard LaTeX Style</a></li>
  <li><a href="#4-2-latex-beamer">4.2. LaTeX Beamer</a></li>
</ul>
<li><a href="#5-pygments">5. Pygments</a></li>
